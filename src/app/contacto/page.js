        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl max-w-3xl mx-auto">
              Estamos listos para ayudarte a impulsar tu negocio con soluciones publicitarias efectivas.
            </p>
          </div>
        </div>
      </section>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-gray-600">Calle Principal #123, Villavicencio, Meta, Colombia</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0 mt-1">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-gray-600">info@publimeta.com</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0 mt-1">
